...
- **Related artifacts**: `docs/request-intake-orchestration.md`, `docs/constitution-amendment-3.0.0.md`, `docs/contracts/deterministic-request-intake-mcp-contract.md`
